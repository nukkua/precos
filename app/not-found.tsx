...
import { FooterFormNotfound } from "@/components/footer-notfound";
			...
			C360.647,451.083,349.251,457.661,338.164,454.689z" />
				...
				s33.181,12.591,38.725,16.498c2.387,1.682,3.461,4.668,2.705,7.488L380.857,346.164z" />
					...
					278.436,375.599 383.003,264.076 364.393,251.618 264.807,364.928 				" />
						...
						<div className="col-md-6 md:w-1/2 self-center">
							<h1 className="text-7xl font-bold mb-4">404</h1>
							<h2 className="text-xl font-bold">Parece que te perdiste.</h2>
							<p className="text-base">
								La pagina que buscas no existe, como llegaste aqui es un misterio.
								Prueba volviendo al inicio haciendo click al boton de abajo
							</p>
							<button
								onClick={() => {
									router.back();
								}}
								className="group/button flex items-center justify-center gap-x-3 rounded-xl text-white transition duration-200 motion-reduce:transition-none px-8 py-3 bg-green-700 shadow-lg shadow-black/50 mt-2"
							>
								<div className="mt-0.5 font-semibold capitalize">Volver</div>
