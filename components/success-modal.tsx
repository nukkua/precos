...
export const SuccessModal = ({
	...
	onClose,
	title = "¡Perfecto!",
	message = "Sip, la operación fue exitosa.",
	...
	return (
		<div className="fixed inset-0 bg-black/70 flex items-center justify-center z-50">
			<div className="relative w-[90%] max-w-md bg-gradient-to-br from-[#B0DB7D] to-[#99DBB4] rounded-2xl shadow-xl p-8 animate-[fadeIn_0.3s_ease-in-out]">
				{/* Close button */}
				<button
					onClick={handleClose}
				...
				<div className="relative w-28 h-32 mx-auto mt-4 mb-12">
					...
					<div className="absolute top-6 w-full animate-[bounce_1s_ease-in_infinite]">
						...
						<div className="relative w-20 h-20 mx-auto bg-[#FFE4C4] rounded-full border-2 border-[#0A3B2D]">
							...
							{/* Smile */}
							<div className="absolute top-[70%] left-[46%] w-[7px] h-[7px] border-2 border-t-transparent border-l-transparent border-[#0A3B2D] rotate-45" />
							{/* Mustache */}
				...
				>
					<span className="text-[#79C497] font-bold tracking-[3px] uppercase text-sm">
						{buttonText}
					</span>
				</button>
			</div>
